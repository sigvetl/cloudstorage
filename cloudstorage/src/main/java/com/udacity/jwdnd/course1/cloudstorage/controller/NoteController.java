...
public class NoteController {
    ...
    public NoteController(NoteService noteService, EncryptionService encryptionService, UserService userService) {
    ...
    public String addUpdateNotes(Authentication authentication, NoteForm noteForm, Model model) {
        ...
        HomeController.getHomeDetails(authentication, model, this.noteService, this.encryptionService, this.userService);
    ...
    public String deleteNotes(@PathVariable("noteid") Integer noteId, Authentication authentication, NoteForm noteForm, Model model) {
